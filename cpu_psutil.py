...
print("使用psutil.cpu_times()获取CPU的完整信息: ",psu.cpu_times())

# 使用psutil.cpu_count()获取CPU的逻辑个数
print("使用psutil.cpu_count()获取CPU的逻辑个数：",psu.cpu_count())

# psutil.cpu_count(logical=False)获取CPU的物理个数；默认logical值为True；
print("psutil.cpu_count(logical=False)获取CPU的物理个数；默认logical值为True；", psu.cpu_count(logical=False))
