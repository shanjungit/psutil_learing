...
class Frame(wx.Frame):
    def __init__(self):
        ...
        stockName_CMBO = wx.ComboBox(self.ParaPanel, -1, "浙大网新", choices=Stock_Name_ComboBox,
                                     style=wx.CB_READONLY | wx.CB_DROPDOWN)  # 股票名称
        stockCode_Text = wx.StaticText(self.ParaPanel, -1, u'股票名称')

        # 日历控件选择数据周期
        self.dpcEndTime = wx.adv.DatePickerCtrl(self.ParaPanel, -1, style=wx.DP_DROPDOWN | wx.DP_ALLOWNONE)  # 结束时间
        self.dpcStartTime = wx.adv.DatePickerCtrl(self.ParaPanel, -1,
        ...
        self.StratInputBox = wx.RadioBox(self.ParaPanel, -1, label=u'策略选取', choices=RadioList, majorDimension=4,
